    ...
    <section className="relative overflow-hidden h-screen flex items-center justify-center bg-amber-400/5 dark:bg-amber-400/10">
      ...
      <div className="container relative mx-auto px-4">
        <div className="flex flex-col items-center justify-center min-h-screen">
          ...
          <h5 className="mb-6 md:text-5xl text-3xl md:leading-normal leading-normal tracking-wider font-bold text-slate-900 dark:text-white">
            Page Not Found
          </h5>
          
          <p className="text-slate-400 dark:text-white/70 max-w-xl mx-auto text-center mb-8">
