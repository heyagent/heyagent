...
export default function PrivacyPolicy() {
  return (
    <main>
      {/* Hero Section */}
      <section className="relative pt-24 sm:pt-32 md:pt-40 lg:pt-48 pb-6 sm:pb-8 md:pb-12 bg-gradient-to-b from-amber-400/15 via-fuchsia-600/10 dark:from-amber-400/25 dark:via-fuchsia-600/15 to-transparent">
