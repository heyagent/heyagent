...
export const tableName = "changelog_entries";

export const route = "changelog-entries";
...
export const relation = relations(table, ({ many }) => ({
  fixes: many(table, { relationName: "changelogFixes" }),
  improvements: many(table, { relationName: "changelogImprovements" }),
}));
