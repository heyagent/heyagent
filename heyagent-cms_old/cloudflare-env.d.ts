/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 73ba088130734bd9788a3a9c3e04e5d1)
// Runtime types generated with workerd@1.20250617.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		CLOUDFLARE_ACCESS_TEAM_DOMAIN: string;
		CLOUDFLARE_ACCESS_APP_AUD: string;
		DB_CHANGELOG: D1Database;
		ASSETS: Fetcher;
	}
}
